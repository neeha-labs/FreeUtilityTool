  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4">
            <div className="flex-1 space-y-2">
              <label className="text-xs font-medium text-slate-500">Shift Value (Key)</label>
              <Input
                type="number"
                value={shift}
            ...
            <div className="flex gap-2 pt-6">
              <Button onClick={() => processText(true)} disabled={!text}>
                <Lock className="h-4 w-4 mr-2" /> Encrypt
              </Button>
              <Button variant="secondary" onClick={() => processText(false)} disabled={!text}>
      ...
      <div className="flex justify-center">
        <Button variant="ghost" onClick={() => { setText(""); setResult(""); setShift(3); }}>
