      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <Button variant="ghost" size="sm" onClick={() => { setInput(""); setOutput(""); }} className="text-slate-400 hover:text-red-500">
              <Trash2 className="w-4 h-4 mr-1" /> Clear
            </Button>
          </div>
          <textarea
            className="w-full h-[400px] p-4 font-mono text-sm border rounded-xl focus:ring-2 focus:ring-indigo-500 outline-none resize-none bg-white shadow-sm"
        ...
        <div className="space-y-2">
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <Button variant="ghost" size="sm" onClick={toggleMode} className="text-indigo-600 hover:bg-indigo-50">
          ...
          <textarea
            readOnly
            className="w-full h-[400px] p-4 font-mono text-sm border rounded-xl outline-none resize-none bg-slate-900 text-indigo-300"
            value={output}
